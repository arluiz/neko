...
public class DestinationsAgreementNUInitializer implements ABCastInitializer {
    ...
    public SenderInterface createSender(NekoProcess process) {
        ...
        abcast = new DestinationsAgreementNU(process);
    ...
    private DestinationsAgreementNU abcast;

    public void setReceiver(ReceiverInterface receiver) {
        abcast.setReceiver(receiver);
    }

} // end class DestinationsAgreementNUInitializer
